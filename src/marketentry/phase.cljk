(ns marketentry.phase
  "Phase 0->3 staged rollout for the Republic of the Congo (COG)
  market-entry compliance actor.
    ...
    Phase 3  supervised auto  -- governor-clean, high-confidence
                                 `:engagement/intake` (no tender/ARMP
                                 filing risk yet) may auto-commit.
  ...
  real BOAMP tender response / ARMP filing package and submitting a
  real filing are the two real-world acts this actor performs; both are
  always a human market-entry operator's call.
