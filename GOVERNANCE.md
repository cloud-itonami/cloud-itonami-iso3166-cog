...
`cloud-itonami-iso3166-cog` is an OSS open-business blueprint. Governance covers both code and
the operator model.
...
Congolese-licensed counsel or a registered agent for whatever licensed
representation the law of the Republic of the Congo requires for
